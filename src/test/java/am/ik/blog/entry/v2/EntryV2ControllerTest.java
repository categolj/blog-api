...
public class EntryV2ControllerTest {
	...
	public void getEntries() throws Exception {
		given(this.documentationSpec) //
				...
				.body("content[0].created.date", equalTo("2017-04-01T01:00:00" + zoneOffset))
				.body("content[0].updated.name", equalTo("making"))
				.body("content[0].updated.date", equalTo("2017-04-01T02:00:00" + zoneOffset))
				...
				.body("content[1].created.date", equalTo("2017-04-01T00:00:00" + zoneOffset))
				.body("content[1].updated.name", equalTo("making"))
				.body("content[1].updated.date", equalTo("2017-04-01T00:00:00" + zoneOffset))
				...
				.body("content[2].created.date", equalTo("2017-03-31T00:00:00" + zoneOffset))
				.body("content[2].updated.name", equalTo("making"))
				.body("content[2].updated.date", equalTo("2017-03-31T00:00:00" + zoneOffset))
	...
	public void searchEntries_ModifiedData() throws Exception {
		given().log().all().queryParam("q", "test").get("/entries").then().log().all()
				...
				.body("content[1].created.date", equalTo("2017-03-31T00:00:00" + zoneOffset))
				.body("content[1].updated.name", equalTo("making"))
				.body("content[1].updated.date", equalTo("2017-03-31T00:00:00" + zoneOffset))
	...
	public void getEntry() throws Exception {
		given(this.documentationSpec) //
				...
				.body("created.date", equalTo("2017-04-01T01:00:00" + zoneOffset))
				.body("updated.name", equalTo("making"))
				.body("updated.date", equalTo("2017-04-01T02:00:00" + zoneOffset))
				.body("created.name", equalTo("making"))
