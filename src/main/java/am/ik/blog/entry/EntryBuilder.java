...
public class EntryBuilder {
	...
	public static Optional<Tuple3<EntryBuilder, Optional<OffsetDateTime>, Optional<OffsetDateTime>>> createFromYamlFile(
			Resource file) {
	...
	public static Optional<Tuple3<EntryBuilder, Optional<OffsetDateTime>, Optional<OffsetDateTime>>> parseBody(
			Long entryId, InputStream body) {
		return parseBody(entryId, new InputStreamReader(body, StandardCharsets.UTF_8));
	}

	public static Optional<Tuple3<EntryBuilder, Optional<OffsetDateTime>, Optional<OffsetDateTime>>> parseBody(
			Long entryId, String body) {
		return parseBody(entryId, new StringReader(body));
	}

	private static Optional<Tuple3<EntryBuilder, Optional<OffsetDateTime>, Optional<OffsetDateTime>>> parseBody(
			Long entryId, Reader r) {
